...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2492.6890497595077; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1075.835093399848; // x position of the perpendicular encoder (in tick units)
    }
